    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privacy', models.CharField(default=b'privacy_public', max_length=b'256', choices=[(b'privacy_public', b'Public'), (b'private_to_all_friends', b'Friends'), (b'private_to', b'Specified Users'), (b'private_to_me', b'Me'), (b'privacy_unlisted', b'Unlisted'), (b'privacy_server_only', b'Server Only'), (b'private_to_fof', b'Friends-of-Friends')])),
                ...
                ('private_to', models.ManyToManyField(related_name='allowed_author', to='users.Profile', blank=True)),
            ],
            options={
                'ordering': ('-created',),
            },
